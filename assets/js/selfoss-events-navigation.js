...
selfoss.events.navigation = function() {
        ...
        change: function(color) {
            ...
            $.ajax({
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    selfoss.ui.showError(selfoss.translate('error_saving_color') + ' ' +
    ...
    $('#nav-sources-title').unbind('click').click(function() {
        ...
        if (selfoss.filter.sourcesNav && !selfoss.sourcesNavLoaded) {
            $.ajax({
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    selfoss.ui.showError(selfoss.translate('error_loading_stats') + ' ' +
                                         textStatus + ' ' + errorThrown);
                }
            });
        } else {
    ...
    $('#nav-refresh').unbind('click').click(function() {
        ...
        $.ajax({
            ...
            success: function() {
                ...
                selfoss.dbOnline.sync().done(function() {
                    if ($('.unread-count').hasClass('unread')) {
                        selfoss.ui.showMessage(selfoss.translate('sources_refreshed'), selfoss.translate('reload_list'),
                            function() {
            ...
            error: function(jqXHR, textStatus, errorThrown) {
                selfoss.ui.showError(selfoss.translate('error_refreshing_source') + ' ' + errorThrown);
            },
            complete: function() {
