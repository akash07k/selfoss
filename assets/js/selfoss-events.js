        ...
        if ($.inArray(selfoss.events.section,
            ...
            if (selfoss.events.subsection) {
                ...
                if (selfoss.events.subsection.substr(0, 4) == 'tag-') {
                    ...
                    selfoss.ui.showError(selfoss.translate('error_invalid_subsection') + ' '
                                         + selfoss.events.subsection);
                    done();
                    return;
                }
            ...
            selfoss.activeAjaxReq = $.ajax({
                ...
                error: function(jqXHR, textStatus, errorThrown) {
                    ...
                    selfoss.handleAjaxError(jqXHR.status, false).fail(function() {
                        selfoss.ui.showError(selfoss.translate('error_loading') + ' ' +
            ...
            selfoss.ui.showError(selfoss.translate('error_invalid_subsection') + ' ' + selfoss.events.section);
        }
        done();
    },
